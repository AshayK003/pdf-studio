...
class Theme:
    ...
    def ledger(cls) -> Theme:
        ...
        return cls(
            ...
            surface="#F0FDF4",
            body_text="#1F2937",
            muted_text="#374151",  # darker gray for AA contrast on white
            accent="#B45309",
            good="#047857",
            bad="#B91C1C",
            grid="#D1FAE5",
            series=["#064E3B", "#B45309", "#0F766E", "#374151", "#166534"],
            h0="#064E3B",
            h1="#064E3B",
            h2="#065F46",
        )
    ...
    def slate(cls) -> Theme:
        ...
        return cls(
            ...
            surface="#EEF2FF",
            body_text="#334155",
            muted_text="#475569",  # darker gray for AA contrast on white
            accent="#D97706",
            good="#047857",
            bad="#B91C1C",
            grid="#E0E7FF",
            series=["#312E81", "#D97706", "#0E7490", "#475569", "#1E3A8A"],
            h0="#312E81",
            h1="#312E81",
            h2="#3730A3",
        )
